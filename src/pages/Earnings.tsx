    ...
    <div className="min-h-screen bg-surface-container-lowest text-charcoal-ink">
      <header className="border-b border-parchment-border bg-white px-8 py-4 flex items-center justify-between">
        <div className="flex gap-6 items-center">
          ...
          <Link to="/team" className="text-charcoal-ink/60 hover:text-charcoal-ink font-semibold">Team</Link>
          <Link to="/earnings" className="text-amethyst-link font-semibold border-b-2 border-amethyst-link pb-1">Earnings</Link>
          <Link to="/transactions" className="text-charcoal-ink/60 hover:text-charcoal-ink font-semibold">Transactions</Link>
        </div>
      </header>
      <main className="max-w-[1000px] mx-auto p-8 mt-8">
        ...
        <div className="bg-white p-6 rounded-[16px] border border-parchment-border shadow-sm">
          <p className="text-charcoal-ink/70">Earnings history (reward settlements) will be displayed here.</p>
        </div>
      </main>
    </div>
  );
